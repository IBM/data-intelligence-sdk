...
class DphV1(BaseService):
    ...
    def _set_accept_header(self, headers: Dict, accept_type: Optional[str] = CONTENT_TYPE_JSON) -> None:
        """
        Set the Accept header if not already present.

        :param headers: Headers dictionary to update
        :param accept_type: The accept type to set (default: CONTENT_TYPE_JSON)
        """
    ...
    def list_data_products(
        ...
        **kwargs,
        ...
        headers = self._prepare_headers('list_data_products', **kwargs)
        self._set_accept_header(headers)
    ...
    def create_data_product(
        ...
        **kwargs,
        ...
        headers = self._prepare_headers('create_data_product', **kwargs)
        self._set_accept_header(headers)
        ...
        data = self._prepare_json_data({'drafts': drafts})
        headers['content-type'] = CONTENT_TYPE_JSON
    ...
    def get_data_product(
        ...
        **kwargs,
        ...
        headers = self._prepare_headers('get_data_product', **kwargs)
        self._set_accept_header(headers)
...
class GetDataProductDraftContractTermsEnums:
    ...
    class Accept(str, Enum):
        ...
        APPLICATION_JSON = CONTENT_TYPE_JSON
